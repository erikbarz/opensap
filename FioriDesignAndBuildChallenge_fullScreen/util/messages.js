jQuery.sap.declare("FioriDesignAndBuildChallenge_fullScreen.util.messages");
jQuery.sap.require("sap.ca.ui.message.message");

FioriDesignAndBuildChallenge_fullScreen.util.messages = {};
 ...
 * @public
 */
FioriDesignAndBuildChallenge_fullScreen.util.messages.showErrorMessage = function(oParameter) {
	var oErrorDetails = FioriDesignAndBuildChallenge_fullScreen.util.messages._parseError(oParameter);
...
FioriDesignAndBuildChallenge_fullScreen.util.messages.getErrorContent = function(oParameter) {
	return FioriDesignAndBuildChallenge_fullScreen.util.messages._parseError(oParameter).sMessage;
};

FioriDesignAndBuildChallenge_fullScreen.util.messages._parseError = function(oParameter) {
	var sMessage = "",
		sDetails = "",
		oEvent = null,
		oResponse = null,
