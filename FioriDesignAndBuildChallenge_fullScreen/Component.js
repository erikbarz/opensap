...
jQuery.sap.declare("FioriDesignAndBuildChallenge_fullScreen.Component");
jQuery.sap.require("sap.ui.core.UIComponent");
jQuery.sap.require("sap.ui.core.routing.History");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");

sap.ui.core.UIComponent.extend("FioriDesignAndBuildChallenge_fullScreen.Component", {
    metadata : {
        "name" : "FioriDesignAndBuildChallenge_fullScreen",
        "version" : "1.1.0-SNAPSHOT",
        "library" : "FioriDesignAndBuildChallenge_fullScreen",
        ...
        routing : {
            ...
            config : {
                "viewType" : "XML",
                "viewPath" : "FioriDesignAndBuildChallenge_fullScreen.view",
    ...
    createContent : function() {
        ...
        return sap.ui.view({
            viewName : "FioriDesignAndBuildChallenge_fullScreen.view.Main",
    ...
    init : function() {
        ...
        var sRootPath = jQuery.sap.getModulePath("FioriDesignAndBuildChallenge_fullScreen");
    ...
    _initODataModel : function(sServiceUrl) {
        jQuery.sap.require("FioriDesignAndBuildChallenge_fullScreen.util.messages");
        var oConfig = {
            metadataUrlParams : {},
            json : true,
        ...
        oModel.attachRequestFailed(null, FioriDesignAndBuildChallenge_fullScreen.util.messages.showErrorMessage);
