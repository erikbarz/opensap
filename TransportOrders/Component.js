...
jQuery.sap.declare("TransportOrders.Component");
jQuery.sap.require("sap.ui.core.UIComponent");
jQuery.sap.require("sap.ui.core.routing.History");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");

sap.ui.core.UIComponent.extend("TransportOrders.Component", {
    metadata : {
        "name" : "TransportOrders",
        "version" : "1.1.0-SNAPSHOT",
        "library" : "TransportOrders",
    ...
    createContent : function() {
        ...
        return sap.ui.view({
            viewName : "TransportOrders.view.Main",
    ...
    init : function() {
        ...
        var sRootPath = jQuery.sap.getModulePath("TransportOrders");
    ...
    _initODataModel : function(sServiceUrl) {
        jQuery.sap.require("TransportOrders.util.messages");
        var oConfig = {
            metadataUrlParams : {},
            json : true,
        ...
        oModel.attachRequestFailed(null, TransportOrders.util.messages.showErrorMessage);
