sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("es4products/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("es4products.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["es4products/localService/mockserver"], function (mockserver) {
