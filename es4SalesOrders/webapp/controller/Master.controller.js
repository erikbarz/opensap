...
sap.ui.define([
		...
		"es4salesorders/model/grouper",
		"es4salesorders/model/GroupSortState"
		...
		return BaseController.extend("es4salesorders.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("es4salesorders.view.ViewSettingsDialog", this);
