sap.ui.define([
		...
		return BaseObject.extend("es4salesorders.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias es4salesorders.model.ListSelector
			 */
			 ...
			 * @return {es4salesorders.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
