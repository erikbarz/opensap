sap.ui.define([
			...
			return BaseController.extend("es4salesorders.controller.Tile", {

					//sURI: jQuery.sap.getModulePath("es4salesorders") + "/destinations/northwind/V3/Northwind/Northwind.svc/",
					sURI: jQuery.sap.getModulePath("es4salesorders") + "/sap/opu/odata/sap/ZTG_TEST_SRV",
					oModel: null,
					counter: 0,
					employeeArray: null,
					...
					onAfterRendering: function() {
						...
						this.oModel.read("/Product", parameters);
					},
